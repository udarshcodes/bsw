...
# --- App Layout ---
app.layout = html.Div(
    style={'backgroundColor': '#111111', 'color': '#FFFFFF', 'fontFamily': 'Inter', 'minHeight': '100vh'},
    children=[
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        dcc.Slider(
                            id='theta-slider', min=0, max=180, step=1, value=0,
                        ...
                        html.Div([
                            ...
                            html.Div(
                                ...
                                children=[
                                    ...
                                    dcc.Input(
                                        id='phi-input', type='number', placeholder='φ',
